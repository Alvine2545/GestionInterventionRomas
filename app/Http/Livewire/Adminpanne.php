...
class Adminpanne extends Component
{
    ...
    public function render()
    {
        ...
        $this->users = DB::table('users')->join('roles_users', 'roles_users.user_id', '=', 'users.id')->join('roles', 'roles.id', '=', 'roles_users.roles_id')->where('roles.nom', 'Client')->select('users.nom as nom', 'roles.nom as role' , 'users.id as id')->get();
