    ...
    <header id="header" class="h-max w-max">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="{{asset('res/imgs/maintenance.jpg')}}" class="mx-auto my-auto" alt="">
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-12 col-lg-6 col-xl-6">
                <img src="res/imgs/developpement2.jpg" class="w-100 h-100" alt="">
            </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-12 col-lg-6 col-xl-6">
                <img src="res/imgs/conception1.jpg" class="w-100 h-100" alt="">
            </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-12 col-lg-6 col-xl-6">
                <img src="res/imgs/vente1.jpg" class="w-100 h-100" alt="">
            </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-12 col-lg-6 col-xl-6">
                <img src="res/imgs/maintenance2.jpg" class="w-100 h-100" alt="">
            </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-12 col-lg-6 col-xl-6">
                <img src="res/imgs/formation2.jpg" class="w-100 h-100" alt="">
            </div>
...
<section id="contact" class="py-5">
    <div class="container">
        <div class="title text-center">
            <h2 class="position-relative d-inline-block">Signaler une panne</h2>
        </div>
        @if (Auth::check())
