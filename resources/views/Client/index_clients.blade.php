            ...
            <!--ul class="pcoded-submenu">
                ...
                <li class=" ">
                    <a href="dashboard-analytics.htm">
                        ...
                        <span class="pcoded-badge label label-info ">Interventions</span>
                    </a>
                </li>
            </ul-->
        </li>
    ...
    <ul class="pcoded-item pcoded-left-item">
        <li class="pcoded-hasmenu">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class=" ">
                    <a href="{{route('')}}">
                        <span class="pcoded-mtext">Enregistrer client</span>
                    </a>
                </li>
                <li class=" ">
                    <a href="other.htm">
            ...
            <ul class="pcoded-submenu">
                <li class=" ">
                    <a href="session-timeout.htm">
                        <span class="pcoded-mtext">Créer un emploi de temps</span>
                    </a>
                </li>
                <li class=" ">
    ...
    <ul class="pcoded-item pcoded-left-item">
        <li class="pcoded-hasmenu">
            <a href="javascript:void(0)">
                ...
                <span class="pcoded-mtext">Gérer devis</span>
            </a>
            <ul class="pcoded-submenu">
                <li class=" ">
    ...
    <ul class="pcoded-item pcoded-left-item">
        ...
        <li class="">
            <a href="#" target="_blank">
                ...
                <span class="pcoded-mtext">Messageri</span>
            </a>
        </li>
    </ul>
</div>
    ...
    <div class="col-lg-4">
        <div class="page-header-breadcrumb">
            <ul class="breadcrumb-title">
                ...
                <li class="breadcrumb-item"><a href="#!">Tableau</a>
                </li>
            </ul>
        </div>
    </div>
