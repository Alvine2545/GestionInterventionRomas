    ...
    <ul class="pcoded-item pcoded-left-item">
        <li class="pcoded-hasmenu">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="">
                    <a href="dashboard-crm.htm">
                        <span class="pcoded-mtext">Les demandes</span>
                    </a>
                </li>
            </ul>
        </li>
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class=" ">
                            <a href="menu-header-fixed.htm">
                                <span class="pcoded-mtext">Appréciations</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="pcoded-submenu">
                <li class="">
                    <a href="widget-statistic.htm">
                        <span class="pcoded-mtext">Créer un client</span>
                    </a>
                </li>
                <li class=" ">
    ...
    <ul class="pcoded-item pcoded-left-item">
        ...
        <li class="">
            <a href="#" target="_blank">
                ...
                <span class="pcoded-mtext">Messagerie</span>
            </a>
        </li>
    </ul>
</div>
        ...
        @method('POST')
          <div class="card-block">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="type" placeholder="Nom">
                        <span class="messages popover-valid"></span>
                    </div>
                </div>
                  <div class="row">
